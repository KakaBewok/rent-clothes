            ...
            <Link href="#">
                ...
                {product.additional_ribbon && (
                    <div className="absolute top-0 left-0 z-10 rounded-tl-sm rounded-br-sm bg-first px-1.5 py-0.5">
                        <p className="text-[10px] font-normal text-white md:text-[12px]">{product.additional_ribbon}</p>
                    </div>
                )}
                ...
                <div className="overflow-hidden rounded-sm">
                    <img
                        ...
                        className="aspect-[2/3] w-full transform bg-gray-200 object-cover transition-all duration-300 group-hover:opacity-80 hover:scale-105"
                    />
                </div>
                ...
                <div className="mt-2 flex justify-between px-0 md:px-1">
                    <div className="space-y-1 lg:space-y-1.5">
                        ...
                        <p className="text-xs text-slate-500">
                            {formatRupiah(product.price_detail?.price_after_discount)} /1-
                            {product.rent_periode} days
                        </p>
                                ...
                                return (
                                    <>
                                        ...
                                        {availableSizes.length > 2 && (
                                            <span className="rounded bg-slate-100 px-2 py-0.5 text-[9px] text-slate-500 md:text-[10px]">
                                                + {availableSizes.length - 2}
                                            </span>
                                        )}
                                    </>
